...
Комплект перенесён из `templates_qwen_agents/` в корень проекта и
работает как постоянный агентный режим. Исходный шаблон —
`templates_qwen_agents` — не изменялся.
...
1. **Привязка к flask-blog-1.** Раньше комплект описывал абстрактную «Гостевую книгу»;
   теперь QWEN.md/AGENTS.md/README.md построены на корневых `QWEN.md`, `AGENTS.md`,
   `README.md` текущего проекта: обзор, стек, архитектура, запуск, соглашения, грабли.
2. **Имена файлов:** `../README.md`, `../QWEN.md`, `../AGENTS.md`,
...
- `../.qwen/agents` — четыре универсальных агента.
